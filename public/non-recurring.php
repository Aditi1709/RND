...
<div class="container">
  ...
  <button type="button" name="Edit" style="margin:16px" class="btn btn-dark"><a href="http://localhost/DBMSMinorProject/public/nonrecurringedit.php">Edit</a></button></br>
...
$result = mysqli_query($conn,"SELECT * FROM NonRecurring WHERE Proj_Id=(SELECT Proj_Id FROM PI WHERE Email = '".$ema."')") or die(mysqli_error($conn));
